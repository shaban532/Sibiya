...
return [
    ...
    'timestamp' => 1694178821,
    'checksum' => 'a20c1b80741e21c671da53398e1ce8ef',
    'files' => [
        ...
        'user/themes' => [
            ...
            'themes/mustard copy' => [
                'file' => 'user/themes/mustard copy/blueprints.yaml',
                'modified' => 1687361640
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.mustard copy.production-mode' => [
                'type' => 'toggle',
                'label' => 'Production mode',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.mustard copy.production-mode',
                'validation' => 'loose'
            ],
            'themes.mustard copy.grid-size' => [
                'type' => 'select',
                'label' => 'THEME_QUARK.ADMIN.GRID_SIZE',
                'size' => 'small',
                'options' => [
                ...
                'name' => 'themes.mustard copy.grid-size',
                'validation' => 'loose'
            ],
            'themes.mustard copy.header_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.mustard copy.header_section',
                'validation' => 'loose'
            ],
            'themes.mustard copy.custom_logo' => [
                'type' => 'file',
                'label' => 'Custom Logo',
                'size' => 'large',
                'destination' => 'theme://images/logo',
                ...
                'name' => 'themes.mustard copy.custom_logo',
                'validation' => 'loose'
            ],
            'themes.mustard copy.custom_logo_mobile' => [
                'type' => 'file',
                'label' => 'Mobile Custom Logo',
                'size' => 'large',
                'destination' => 'theme://images/logo',
                ...
                'name' => 'themes.mustard copy.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.mustard copy.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.mustard copy.header-fixed',
                'validation' => 'loose'
            ],
            'themes.mustard copy.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.mustard copy.header-animated',
                'validation' => 'loose'
            ],
            'themes.mustard copy.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.mustard copy.header-dark',
                'validation' => 'loose'
            ],
            'themes.mustard copy.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.mustard copy.header-transparent',
                'validation' => 'loose'
            ],
            'themes.mustard copy.footer_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.mustard copy.footer_section',
                'validation' => 'loose'
            ],
            'themes.mustard copy.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.mustard copy.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.mustard copy.blog_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.mustard copy.blog_section',
                'validation' => 'loose'
            ],
            'themes.mustard copy.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.mustard copy.blog-page',
                'validation' => 'loose'
            ],
            'themes.mustard copy.spectre_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.mustard copy.spectre_section',
                'validation' => 'loose'
            ],
            'themes.mustard copy.spectre' => [
                'type' => '_parent',
                'name' => 'themes.mustard copy.spectre',
                'form_field' => false
            ],
            'themes.mustard copy.spectre.exp' => [
                'type' => 'toggle',
                'label' => 'Experimentals CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.mustard copy.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.mustard copy.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.mustard copy.spectre.icons',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'themes' => [
                ...
                'mustard copy' => [
                    'production-mode' => 'themes.mustard copy.production-mode',
                    'grid-size' => 'themes.mustard copy.grid-size',
                    'header_section' => 'themes.mustard copy.header_section',
                    'custom_logo' => 'themes.mustard copy.custom_logo',
                    'custom_logo_mobile' => 'themes.mustard copy.custom_logo_mobile',
                    'header-fixed' => 'themes.mustard copy.header-fixed',
                    'header-animated' => 'themes.mustard copy.header-animated',
                    'header-dark' => 'themes.mustard copy.header-dark',
                    'header-transparent' => 'themes.mustard copy.header-transparent',
                    'footer_section' => 'themes.mustard copy.footer_section',
                    'sticky-footer' => 'themes.mustard copy.sticky-footer',
                    'blog_section' => 'themes.mustard copy.blog_section',
                    'blog-page' => 'themes.mustard copy.blog-page',
                    'spectre_section' => 'themes.mustard copy.spectre_section',
                    'spectre' => [
                        'exp' => 'themes.mustard copy.spectre.exp',
                        'icons' => 'themes.mustard copy.spectre.icons'
                    ]
                ]
            ]
        ],
