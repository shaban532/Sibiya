...
---
![ نوشته‌ای برای تیم بازسازی خیریه کودکان فرشته‌اند ](bazsazi.webp?classes=center)
...
چند دقیقه‌ٔ بعد حلقهٔ صبح‌مان شروع می‌شود. زهرا که لیدر روز اول است همان نکات همیشگی را توضیح ‌می‌دهد که بدون هماهنگی اقدامی نکنیم و هر حرفی هم که داشتیم با لیدرها در میان بگذاریم و از همه مهم‌تر لطفاً همدیگر را به اسم کوچک صدا نزنیم. خنده‌ام می‌گیرد. هیچ کس را به اسم کوچک صدا نمی‌کنم اما در این نوشته مجبورم که همه را به اسم کوچک بنویسم. می‌توانم امیدوار باشم که هیچ کدامشان این نوشته را نمی‌خوانند و یا اگر می‌خوانند عذر مرا برای یاد کردن همهٔ شان به اسم کوچک می‌پذیرند. 

زهرا می‌گوید که کار را شروع کنیم و بعد چای و نسکافه را در وقت استراحت بخوریم. نیت روزه کرده‌ام. از همین الان با خودم فکر می‌کنم که چه جور باید در مقابل تعارف‌هایشان مقاومت کنم؟! نمی‌شود انگار. وقت استراحت که می‌شود سعی می‌کنم در مقابل تعارف‌های زهرا مقاومت کنم. فکر می‌کند خجالت می‌کشم و  تعارف می‌کنم. برای همین هم کوتاه نمی‌آید. مجبور می‌شوم:
